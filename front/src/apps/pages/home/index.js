...
class Home extends Component {
    ...
    <tbody >
        {employee.map((dado,i) => {
            ...
            <td>{dado.team}</td>
            <td>
            <button className="btn btn-primary" onClick={this.editEmployeePopup.bind(this)}>edit</button>
            <button className="btn btn-danger" onClick={this.deleteEmployeePopup.bind(this,i)}>delete</button></td>
            </tr>)})}
    </tbody>
    </table>
